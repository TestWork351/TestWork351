...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220430_development_b074772d8562b7f54260_20220430002711_archive.zip';
	const ARCHIVE_SIZE		 = '30620475';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'b074772-30002711';
    const SECONDARY_PACKAGE_HASH = '13dffd6-30002711';
	const VERSION			 = '1.4.5';
